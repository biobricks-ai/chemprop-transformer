...
def main(rank, world_size):
    ...
    cpus_per_rank = os.cpu_count() // world_size
    train_workers = min(8, cpus_per_rank)
    val_workers = min(4, cpus_per_rank)

    trnds = mt.TwoClassSequenceShiftDataset("cache/build_tensordataset/multitask_tensors/trn", tokenizer)
    ...
    valds = mt.TwoClassSequenceShiftDataset("cache/build_tensordataset/multitask_tensors/tst", tokenizer)
